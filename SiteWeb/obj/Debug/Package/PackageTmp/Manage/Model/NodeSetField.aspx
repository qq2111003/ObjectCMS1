        ...
        $(function () {
            $("input[name=flag]").change(function () {
                if ($(this).attr("checked")) {
                    $('input[name=ShowInList][value=' + $(this).val() + ']').removeAttr("disabled");
                    $('input[name=ReWriteTitle_' + $(this).val() + ']').removeAttr("disabled");
                    $('input[name=Sort_' + $(this).val() + ']').removeAttr("disabled");
                } else {
                    $('input[name=ShowInList][value=' + $(this).val() + ']').attr("disabled", "disabled").removeAttr("checked");
                    $('input[name=Sort_' + $(this).val() + ']').attr("disabled", "disabled")
                }
            });
...
<body id="Body1" class="panel-noscroll">
    ...
    <div class="panel datagrid" style="width: 596px;">
        <div class="datagrid-wrap panel-body panel-body-noheader" title="" style="width: 594px;
            height: 414px;">
            <div class="datagrid-view" style="width: 594px; height: 414px;">
                <div class="datagrid-view2" style="width: 594px;">
                    <div class="datagrid-header" style="width: 594px; height: 24px;">
                    ...
                    <div class="datagrid-body" style="width: 594px; margin-top: 0px; height: 389px; overflow-x: hidden;">
