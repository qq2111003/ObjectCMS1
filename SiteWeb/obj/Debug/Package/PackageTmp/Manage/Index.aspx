...
<body id="body1" class="easyui-layout">
    ...
    <div region="north" id="layout_north" split="false" style="height: 55px; background: #252525">
    </div>
    <div region="south" id="layout_south" split="false" style="height: 50px; padding: 10px;
        background: #efefef;">
    ...
    <div region="west" id="layout_west" split="true" minwidth="240" style="width: 240px;
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" id="layout_west_center" split="true" title="基础">
    ...
    <div id="layout_center" region="center" style="overflow: hidden;">
        <div id="tabs" class="easyui-tabs" fit="true" border="false">
            <div title="Welcome" style="overflow: hidden;">
            </div>
        </div>
    </div>
